...
pub fn current_session(
    ...
    utc_min: u32,
    weekday: u32,
) -> (TradingSession, &'static SessionConfig) {
...
const ASIA_CONFIG: SessionConfig = SessionConfig {
    primary_tf_minutes: 30,
    secondary_tf_minutes: 60,
    regime: "normal",
...
const LONDON_CONFIG: SessionConfig = SessionConfig {
    primary_tf_minutes: 15,
    secondary_tf_minutes: 30,
    regime: "prefomc",
    style: "breakout",
    size_mult: 0.75,
...
const LONDON_NY_CONFIG: SessionConfig = SessionConfig {
    primary_tf_minutes: 5,
    secondary_tf_minutes: 15,
    regime: "normal",
    style: "breakout",
    size_mult: 1.0,
...
const US_EVENING_CONFIG: SessionConfig = SessionConfig {
    primary_tf_minutes: 60,
    secondary_tf_minutes: 240,
    regime: "normal",
    style: "range",
    size_mult: 0.25,
...
pub fn daily_trading_plan(date_str: &str, utc_hour: u32, utc_min: u32, weekday: u32) -> String {
    ...
    let day_name = if (weekday as usize) < weekday_names.len() {
