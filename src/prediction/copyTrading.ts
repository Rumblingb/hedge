...
function buildIdeaExhaust(idea: Omit<PredictionCopyIdea, "reason" | "exhaust" | "copySafety">): PredictionCopyIdeaExhaust {
    ...
    .map(([key, value]) => {
      ...
      const action = supporterCount >= args.minConsensusWallets
        ...
        && copySafety.pass
          ? "shadow-buy" as const
          : "watch" as const;
      const ideaWithoutExhaust: Omit<PredictionCopyIdea, "reason" | "exhaust" | "copySafety"> = {
        ...ideaBase,
